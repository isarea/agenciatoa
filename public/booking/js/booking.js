...
includeScript ('../public/booking/js/jquery-ui-1.10.3.custom.min.js');
includeScript ('../public/booking/js/jquery.fancyform.js');
includeScript ('../public/booking/js/jquery.placeholder.js');
includeScript ('../public/booking/js/regula.js');
...
(function($){
	$.fn.bookingForm=function(options){
		return this.each(function(){
			...
			object = {
				url: 'public/booking/booking.php', // php-script url
